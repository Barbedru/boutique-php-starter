                    ...
                    <div class="products-grid">
                        ...
                        <article class="product-card">
                            ...
                            <div class="product-card__content">
                                ...
                                <p class="product-card__stock product-card__stock--available"> <?= $products[0]["stock"] ?> </p>
                        ...
                        <article class="product-card">
                            ...
                            <div class="product-card__content">
                                ...
                                <div class="product-card__price">
                                    <span class="product-card__price-current"><?= $products[1]["price"] ?></span>
                                    <span class="product-card__price-old"><?= $products[1]["price"] ?></span>
                                </div>
                                <p class="product-card__stock product-card__stock--low"><?= $products[1]["stock"] ?></p>
                                <div class="product-card__actions">
                                    <form action="panier.html" method="POST">
                        ...
                        <article class="product-card">
                            ...
                            <div class="product-card__content">
                                ...
                                <p class="product-card__stock product-card__stock--available"> <?= $products[2]["stock"] ?> </p>
                                <div class="product-card__actions">
                                    <form action="panier.html" method="POST">
                        ...
                        <article class="product-card">
                            ...
                            <div class="product-card__content">
                                ...
                                <p class="product-card__stock product-card__stock--available"><?= $products[3]["stock"] ?></p>
                                <div class="product-card__actions">
                                    <form action="panier.html" method="POST">
                        ...
                        <article class="product-card">
                            ...
                            <div class="product-card__content">
                                ...
                                <p class="product-card__stock product-card__stock--available"><?= $products[4]["stock"] ?></p>
                                <div class="product-card__actions">
                                    <form action="panier.html" method="POST">
                        ...
                        <article class="product-card">
                            ...
                            <div class="product-card__content">
                                <span class="product-card__category"><?= $products[6]["category"] ?></span>
                                <a href="produit.html?id=7" class="product-card__title"><?= $products[6]["name"] ?></a>
                                <div class="product-card__price"><span class="product-card__price-current"><?= $products[6]["price"] ?></span></div>
                                <p class="product-card__stock product-card__stock--available"><?= $products[6]["stock"] ?></p>
                                <div class="product-card__actions">
                                    <form action="panier.html" method="POST">
